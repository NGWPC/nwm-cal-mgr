...
time = {"time": {"start_time": "2015-12-01 00:00:00", "end_time": "2015-12-30 23:00:00", "output_interval": 3600}}
...
catchment = {
    "tst-1": {
        ...
        "calibration": {
            "CFE": [
                {"param": "some_param", "min": 0.0, "max": 1.0, "init": 0.5},
...
one_catchment = {"catchments": {**catchment}}

two_catchment = {"catchments": {**catchment, **catchment}}
...
evaluation_options = {
    "eval_params": {"evaluation_start": "2015-12-01 00:00:00", "evaluation_stop": "2015-12-30 23:00:00"}
}

...
@pytest.mark.parametrize(
    "data, expected",
    [pytest.param(perfect_data, 1.0), pytest.param(under_estimate, -inf), pytest.param(over_estimate, -inf)],
)
...
@pytest.mark.parametrize(
    "data, expected",
    [pytest.param(perfect_data, 1.0), pytest.param(under_estimate, 0.0), pytest.param(over_estimate, 0)],
)
...
@pytest.mark.parametrize(
    "data, expected",
    [pytest.param(perfect_data, 0.0), pytest.param(under_estimate, -1.0), pytest.param(over_estimate, 1.0)],
)
